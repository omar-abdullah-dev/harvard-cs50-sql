## [Introduction](https://cs50.harvard.edu/sql/notes/1/\#introduction)
...
- First, open up the database using SQLite in the terminal of your [Codespace](https://cs50.dev/).
...
!["Author Name and Book Title columns from different tables"](https://cs50.harvard.edu/sql/notes/1/images/p6.jpg)
...
- Some possible ways to organize books and authors are…
    ...
    - **going back to a one-table approach**: This approach could result in redundancy (duplication of data) if one author writes multiple books or if a book is co-written by multiple authors. Below is a snapshot of the one-table approach with some redundant data.
      ...
      !["One-table approach: author with multiple books"](https://cs50.harvard.edu/sql/notes/1/images/p8.jpg)
...
!["One-to-one relationship"](https://cs50.harvard.edu/sql/notes/1/images/p10.jpg)

- On the other hand, if an author can write multiple books, the relationship is a one-to-many relationship.

!["One-to-many relationship"](https://cs50.harvard.edu/sql/notes/1/images/p11.jpg)
...
!["Many-to-many relationship"](https://cs50.harvard.edu/sql/notes/1/images/p12.jpg)


## [Entity Relationship Diagrams](https://cs50.harvard.edu/sql/notes/1/\#entity-relationship-diagrams)
...
- Each line is this diagram is in crow’s foot notation.
    ...
    - The third line, which looks like a crow’s foot, has many branches. This line means that the entity is related to many rows from another table.
      ...
      !["Lines in ER Diagrams"](https://cs50.harvard.edu/sql/notes/1/images/p17.jpg)
- For example:

    - We read the notation left to right. An author writes one book (or, every author can have one book associated with them).

      !["1-Relation Notation: an author writes one book"](https://cs50.harvard.edu/sql/notes/1/images/p18.jpg)

    - Now, not only does an author write one book but a book is also written by one author.

      !["1-Relation Notation: an author writes one book and one book is written by one author"](https://cs50.harvard.edu/sql/notes/1/images/p19.jpg)
    ...
    - With this addition, an author writes at least one book and a book is written by at least one author. To rephrase, an author could be associated with one or multiple books and a book can be written by one or multiple authors.
      ...
      !["Adding multiple lines: an author writes at least one book and a book is written by at least one author"](https://cs50.harvard.edu/sql/notes/1/images/p20.jpg)
...
### [Questions](https://cs50.harvard.edu/sql/notes/1/\#questions)
...
## [Keys](https://cs50.harvard.edu/sql/notes/1/\#keys)

### [Primary Keys](https://cs50.harvard.edu/sql/notes/1/\#primary-keys)
...
!["Table with ISBNs and book titles"](https://cs50.harvard.edu/sql/notes/1/images/p29.jpg)
...
### [Foreign Keys](https://cs50.harvard.edu/sql/notes/1/\#foreign-keys)
...
!["Relating the books and ratings tables using foreign key"](https://cs50.harvard.edu/sql/notes/1/images/p31.jpg)
...
!["Relating the authors and books tables using a foreign key and another table"](https://cs50.harvard.edu/sql/notes/1/images/p40.jpg)


There is now a table called `authored` that maps the primary key of `books` (`book_id`) to the primary key of `authors` (`author_id`).

### [Questions](https://cs50.harvard.edu/sql/notes/1/\#questions-1)
...
## [Subqueries](https://cs50.harvard.edu/sql/notes/1/\#subqueries)
...
## [`IN`](https://cs50.harvard.edu/sql/notes/1/\#in)
...
### [Questions](https://cs50.harvard.edu/sql/notes/1/\#questions-2)
...
## [`JOIN`](https://cs50.harvard.edu/sql/notes/1/\#join)
...
-- NATURAL JOIN (when column names match)
SELECT column1, column2, ...
FROM table1
NATURAL JOIN table2;
```
...
!["Sea Lions database with tables: sea lions, migrations"](https://cs50.harvard.edu/sql/notes/1/images/p69.jpg)
...
### [Questions](https://cs50.harvard.edu/sql/notes/1/\#questions-3)
...
## [Sets](https://cs50.harvard.edu/sql/notes/1/\#sets)
...
!["Intersection Set of Authors and Translators"](https://cs50.harvard.edu/sql/notes/1/images/p100.jpg)
...
!["Union Set of Authors and Translators"](https://cs50.harvard.edu/sql/notes/1/images/p102.jpg)
...
!["EXCEPT set including people who are only authors"](https://cs50.harvard.edu/sql/notes/1/images/p104.jpg)
...
!["Set — people who are either authors or translators but not both"](https://cs50.harvard.edu/sql/notes/1/images/p107.jpg)
...
### [Questions](https://cs50.harvard.edu/sql/notes/1/\#questions-4)
...
## [Groups](https://cs50.harvard.edu/sql/notes/1/\#groups)
...
### [Questions](https://cs50.harvard.edu/sql/notes/1/\#questions-5)
...
## [Fin](https://cs50.harvard.edu/sql/notes/1/\#fin)
