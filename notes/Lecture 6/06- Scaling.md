## [Lecture 6](https://cs50.harvard.edu/sql/notes/6/#lecture-6)

-   [Introduction](https://cs50.harvard.edu/sql/notes/6/#introduction)
-   [MySQL](https://cs50.harvard.edu/sql/notes/6/#mysql)
-   [Creating the `cards` Table](https://cs50.harvard.edu/sql/notes/6/#creating-the-cards-table)
    -   [Questions](https://cs50.harvard.edu/sql/notes/6/#questions)
-   [Creating the `stations` Table](https://cs50.harvard.edu/sql/notes/6/#creating-the-stations-table)
    -   [Questions](https://cs50.harvard.edu/sql/notes/6/#questions-1)
-   [Creating the `swipes` Table](https://cs50.harvard.edu/sql/notes/6/#creating-the-swipes-table)
    -   [Questions](https://cs50.harvard.edu/sql/notes/6/#questions-2)
-   [Altering Tables](https://cs50.harvard.edu/sql/notes/6/#altering-tables)
-   [Stored Procedures](https://cs50.harvard.edu/sql/notes/6/#stored-procedures)
    -   [Questions](https://cs50.harvard.edu/sql/notes/6/#questions-3)
-   [Stored Procedures with Parameters](https://cs50.harvard.edu/sql/notes/6/#stored-procedures-with-parameters)
-   [PostgreSQL](https://cs50.harvard.edu/sql/notes/6/#postgresql)
    -   [Questions](https://cs50.harvard.edu/sql/notes/6/#questions-4)
-   [Creating PostgreSQL Tables](https://cs50.harvard.edu/sql/notes/6/#creating-postgresql-tables)
-   [Scaling with MySQL](https://cs50.harvard.edu/sql/notes/6/#scaling-with-mysql)
-   [Access Controls](https://cs50.harvard.edu/sql/notes/6/#access-controls)
-   [SQL Injection Attacks](https://cs50.harvard.edu/sql/notes/6/#sql-injection-attacks)
-   [Questions](https://cs50.harvard.edu/sql/notes/6/#questions-5)
-   [Fin](https://cs50.harvard.edu/sql/notes/6/#fin)
...
-   We will use the MBTA database that we have worked with in previous lectures. The following is the ER Diagram showing the entities Card, Swipe and Station and the relationship between these entities.
    ...
    !["ER Diagram for MBTA database with Card, Swipe and Station entities"](https://cs50.harvard.edu/sql/notes/6/images/6.jpg)
...
## [Creating the](https://cs50.harvard.edu/sql/notes/6/#creating-the-cards-table) [`cards`](https://cs50.harvard.edu/sql/notes/6/#creating-the-cards-table) [Table](https://cs50.harvard.edu/sql/notes/6/#creating-the-cards-table)
...
-   MySQL has more granularity with types than SQLite. For example, an integer could be `TINYINT`, `SMALLINT`, `MEDIUMINT`, `INT` or `BIGINT` based on the size of the number we want to store. The following table shows us the size and range of numbers we can store in each of the integer types.
    ...
    !["Table of integer types in MySQL"](https://cs50.harvard.edu/sql/notes/6/images/12.jpg)
...
## [Creating the](https://cs50.harvard.edu/sql/notes/6/#creating-the-stations-table) [`stations`](https://cs50.harvard.edu/sql/notes/6/#creating-the-stations-table) [Table](https://cs50.harvard.edu/sql/notes/6/#creating-the-stations-table)
...
## [Creating the](https://cs50.harvard.edu/sql/notes/6/#creating-the-swipes-table) [`swipes`](https://cs50.harvard.edu/sql/notes/6/#creating-the-swipes-table) [Table](https://cs50.harvard.edu/sql/notes/6/#creating-the-swipes-table)
...
-   In SQLite, we had a `REAL` data type. Here, our options are `FLOAT` and `DOUBLE PRECISION` as shown in the table below.
    ...
    !["Real Data types in MySQL"](https://cs50.harvard.edu/sql/notes/6/images/36.jpg)
...
-   What happens if I call `sell` on the same ID more than once? There is a danger of it being added multiple times to the `transactions` table. Stored procedures can be considerably improved in logic and complexity by using some regular old programming constructs. The following list contains some popular constructs available in MySQL.
    ...
    !["Programming constructs in MySQL"](https://cs50.harvard.edu/sql/notes/6/images/70.jpg)
...
-   Going back to the MBTA database which had a table `cards`, let’s see what data types are available to us in PostgreSQL.
    ...
    !["Integer types in PostgreSQL"](https://cs50.harvard.edu/sql/notes/6/images/74.jpg)
